    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (result.error && result.error.includes("validation")) {
          ...
          errorMessage =
            "CSV validation failed. Please check the format and try again.";
        }
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Import transactions from vending machine providers
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <Card className="lg:col-span-2 shadow-lg">
              <CardHeader>
                ...
                <CardDescription>
                  Upload sales data from your vending machine providers to
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Select value={dataSource} onValueChange={setDataSource}>
                      ...
                      <SelectContent>
                        <SelectItem value="vendor_a">
                          Vendor A (iOS Vending Systems)
                        </SelectItem>
                        <SelectItem value="vendor_b">
                          Vendor B (Cantaloupe Systems)
                        </SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
            ...
            <Card className="shadow-lg">
              <CardHeader>
                ...
                <CardDescription>
                  Download sample files or check the required format.
                </CardDescription>
              </CardHeader>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="bg-gray-50 border rounded p-3 text-xs font-mono overflow-x-auto">
                          ...
                          <br />
                          2.0_SW_02,Celsius
                          Arctic,889392014,06/09/2025,3.50,3.82
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <ul className="text-xs space-y-1 text-gray-700">
                          ...
                          <li>
                            <span className="font-semibold">Scancode:</span>{" "}
                            UPC/barcode of the product
                          </li>
                          <li>
                            <span className="font-semibold">Trans_Date:</span>{" "}
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="bg-gray-50 border rounded p-3 text-xs font-mono overflow-x-auto">
                          ...
                          <br />
                          SW_02,Celsius Arctic
                          Berry,889392014,2025-06-09,3.50,3.82
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <ul className="text-xs space-y-1 text-gray-700">
                          <li>
                            <span className="font-semibold">Site_Code:</span>{" "}
                            Vending machine location code
                          </li>
                          <li>
                          ...
                          <li>
                            <span className="font-semibold">Final_Total:</span>{" "}
                            Total amount with tax
                          </li>
                        </ul>
                      </div>
